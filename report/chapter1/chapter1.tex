...
\subsection{Bước 1: Xây dựng dữ liệu pretraining LVD-142M}
...
\subsection{Bước 2: Kiến trúc mô hình và cơ chế student-teacher}
...
\subsection{Bước 3: Objective học tự giám sát}
...
\subsection{Bước 4: Recipe huấn luyện khi scale lớn}
...
\subsection{Bước 5: High-resolution adaptation}
...
\subsection{Bước 6: Tối ưu triển khai để huấn luyện mô hình lớn}
...
\subsection{Bước 7: Distillation từ ViT-g sang các model nhỏ}
...
\subsection{Bước 8: Giao thức đánh giá}
